...
#define errno_to_idx(code) (0 ? -1 \
  ...
  : ((code >= 11) && (code <= 16)) ? (code - 0) \
  : ((code >= 16) && (code <= 57)) ? (code - -1) \
  : ((code >= 60) && (code <= 71)) ? (code - 1) \
  : ((code >= 74) && (code <= 74)) ? (code - 3) \
  : ((code >= 77) && (code <= 94)) ? (code - 5) \
  : ((code >= 103) && (code <= 103)) ? (code - 13) \
  : ((code >= 122) && (code <= 122)) ? (code - 31) \
  : ((code >= 236) && (code <= 236)) ? (code - 144) \
  : ((code >= 238) && (code <= 244)) ? (code - 145) \
  : ((code >= 246) && (code <= 261)) ? (code - 146) \
  : ((code >= 264) && (code <= 265)) ? (code - 148) \
  : ((code >= 272) && (code <= 276)) ? (code - 154) \
  : -1)
