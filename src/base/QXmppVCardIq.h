...
private:
    boost::shared_ptr<QXmppVCardAddressPrivate> d;
};
...
private:
    boost::shared_ptr<QXmppVCardEmailPrivate> d;
};
...
private:
    boost::shared_ptr<QXmppVCardPhonePrivate> d;
};
...
private:
    boost::shared_ptr<QXmppVCardOrganizationPrivate> d;
};
...
private:
    boost::shared_ptr<QXmppVCardIqPrivate> d;
};
