...
private:
    boost::shared_ptr<QDnsDomainNameRecordPrivate> d;
...
private:
    boost::shared_ptr<QDnsHostAddressRecordPrivate> d;
    friend class QDnsLookupRunnable;
};
...
private:
    boost::shared_ptr<QDnsMailExchangeRecordPrivate> d;
    friend class QDnsLookupRunnable;
};
...
private:
    boost::shared_ptr<QDnsServiceRecordPrivate> d;
    friend class QDnsLookupRunnable;
};
...
private:
    boost::shared_ptr<QDnsTextRecordPrivate> d;
    friend class QDnsLookupRunnable;
};
